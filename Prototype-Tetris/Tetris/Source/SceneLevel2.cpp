...
bool SceneLevel2::Start()
{
	...
	App->tetromino->speed = App->tetromino->speed4;
...
Update_Status SceneLevel2::PostUpdate()
{
	...
	App->fonts->BlitText(175, 210, BlueFont, "4");
...
int SceneLevel2::ConstChartoInt(const char* x) { // Function that converts const char* to int
...
int SceneLevel2::StrToInt(string x) { // Function that converts string to int
	int temp = 0;
...
void SceneLevel2::Lines(int lines) {
...
void SceneLevel2::RedScore(int value) {
...
void SceneLevel2::AddPlayer(string P, int score) {
	bool isEmpty = false;
	fstream ScoreSave;
...
string SceneLevel2::Sorter(string Player1) {
	int ACF = Currentpos;
	int CF = 0;
	for (int i = 0; i < 16; i++) {
...
void SceneLevel2::Score(int score) {
	fstream Score;
	int i = 0;
